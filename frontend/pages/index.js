...
export default function Home() {
	...
	const [playerAvatar, setPlayerAvatar] = useState('avatar.png');
	...
	return (
		<>
			...
			<div className="main h-screen">
				...
				<div className="flex flex-col justify-center items-center w-1/4 p-4 border-2 border-gray-100 rounded-lg">
					<h2 className="mb-4">Play With Friend</h2>
					...
					<div className="w-full mb-4">
						...
						<div className="flex flex-row justify-evenly w-full">
							<div className={`${player === 'x' ? 'bg-green-300 text-white' : 'bg-gray-200'} flex flex-row justify-center rounded-xl w-10 cursor-pointer`} onClick={() => setPlayer('x')}>
							...
							<div className={`${player === 'o' ? 'bg-green-300 text-white' : 'bg-gray-200'} flex flex-row justify-center rounded-xl w-10 cursor-pointer`} onClick={() => setPlayer('o')}>
					...
					<div className="m-3 flex justify-center">
						<button className="bg-white text-gray-800 font-normal focus:outline-none rounded-lg border-b-2 border-green-500 hover:border-green-600 hover:bg-green-500 hover:text-white shadow-md py-2 px-6 inline-flex items-center">
